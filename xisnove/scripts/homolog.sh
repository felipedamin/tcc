...
mvn compile exec:java -Dexec.mainClass=xisnove.AstFindAllConditionalModifier -Dexec.args="$parseFile false" #DESIRED_CLASS add args with full path of desired directory
