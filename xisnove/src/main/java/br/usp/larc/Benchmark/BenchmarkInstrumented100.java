...
public class BenchmarkInstrumented100 {
    ...
    public static long getNanotime() throws IOException {
        ...
        LogFile.write("Benchmark100#getNanotime", "ifStmt", "b != 10", b != 10, "[b]", String.valueOf(b));
        if (b != 10) {
            System.out.println("Condition is true");
        } else {
            System.out.println("Condition is false");
        }
        LogFile.write("Benchmark100#getNanotime", "ifStmt", "boolean1", boolean1);
        if (boolean1) {
            System.out.println("Condition is true");
        } else {
            System.out.println("Condition is false");
        }
        LogFile.write("Benchmark100#getNanotime", "ifStmt", "boolean2", boolean2);
        if (boolean2) {
            System.out.println("Condition is true");
        } else {
            System.out.println("Condition is false");
        }
        LogFile.write("Benchmark100#getNanotime", "ifStmt", "a == b", a == b, "[a, b]", String.valueOf(a), String.valueOf(b));
        if (a == b) {
            System.out.println("Condition is true");
        } else {
            System.out.println("Condition is false");
