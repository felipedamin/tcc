 ...
 */
package br.usp.larc.Benchmark.ApacheCommons.KeyValue;
 ...
 * @since 3.0
 */
public class DefaultKeyValueInstrumented<K, V> extends AbstractKeyValue<K, V> {

    /**
     * Constructs a new pair with a null key and null value.
     */
    public DefaultKeyValueInstrumented() {
        super(null, null);
    }
     ...
     */
    public DefaultKeyValueInstrumented(final K key, final V value) {
        super(key, value);
    }
     ...
     */
    public DefaultKeyValueInstrumented(final KeyValue<? extends K, ? extends V> pair) {
     ...
     * @throws NullPointerException if the entry is null
     */
    public DefaultKeyValueInstrumented(final Map.Entry<? extends K, ? extends V> entry) {
    ...
    public K setKey(final K key) {
        LogFile.write("DefaultKeyValue#setKey", "ifStmt", "key == this", key == this, "[key]", String.valueOf(key));
        if (key == this) {
    ...
    public V setValue(final V value) {
        LogFile.write("DefaultKeyValue#setValue", "ifStmt", "value == this", value == this, "[value]", String.valueOf(value));
        if (value == this) {
    ...
    public boolean equals(final Object obj) {
        LogFile.write("DefaultKeyValue#equals", "ifStmt", "obj == this", obj == this, "[obj]", String.valueOf(obj));
        if (obj == this) {
            return true;
        }
        LogFile.write("DefaultKeyValue#equals", "ifStmt", "!(obj instanceof DefaultKeyValue)", !(obj instanceof DefaultKeyValue));
