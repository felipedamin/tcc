package main.java.br.usp.larc.xisnove;
...
public class FlaggedConditions {
    ...
    public static Map<String, ArrayList<String>> getConditions() throws FileNotFoundException {
        ...
        // TODO: mudar "xisnove" para "xisnove"
        Path frequencyAnalysisFile = Paths.get("src/main/java/xisnove/frequency_analyser/conditions_of_interest.out").toAbsolutePath();
        // Path frequencyAnalysisFile = Paths.get("tcc/xisnove/src/main/java/xisnove/frequency_analyser/conditions_of_interest.out").toAbsolutePath();
